...
vectorizer = TfidfVectorizer(max_features=4260)  # Fixed feature count
...
# ---------------------------
# 7️⃣ Training XGBoost Model
# ---------------------------
print("🤖 Training XGBoost Model...")
model = xgb.XGBClassifier(n_estimators=100, max_depth=10, learning_rate=0.1, verbosity=1)
...
# Ensure feature shape consistency
