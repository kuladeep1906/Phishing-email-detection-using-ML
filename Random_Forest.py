...
# ---------------------------
dataset_folder = r"C:\Users\ravip\Downloads\archive"
dataset_paths = [
...
vectorizer = TfidfVectorizer(max_features=3000)  # Optimized feature size
...
# ---------------------------
# 7️⃣ Training Random Forest Model (Optimized)
# ---------------------------
print("🤖 Training Random Forest Model...")
model = RandomForestClassifier(n_estimators=50, max_depth=20, min_samples_split=5, n_jobs=2, warm_start=True)
